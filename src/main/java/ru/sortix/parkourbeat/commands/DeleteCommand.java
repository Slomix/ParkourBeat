...
public class DeleteCommand implements CommandExecutor, TabCompleter {
    ...
    public DeleteCommand(LevelEditorsManager levelEditorsManager, LevelsManager levelsManager, GameManager gameManager) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (levelsManager.getAllLevels().contains(worldId)) {
            ...
            if (!level.getLevelSettings().getGameSettings().getOwner().equals(sender.getName()) && !sender.isOp()) {
