...
public class Heads {
    ...
    @NonNull public static ItemStack getHeadByRawData(@NonNull String data) {
    ...
    @NonNull private static String replaceFirst(@NonNull String input, @NonNull String prefix) {
    ...
    @NonNull public static ItemStack getHeadByLicenseName(@NonNull String name) {
        return createPlayerHeadWithProfile(Bukkit.createProfile(UUID.randomUUID(), name));
    }

    @NonNull public static ItemStack getHeadByGamer(@NonNull Player player) {
    ...
    @NonNull public static ItemStack getHeadWithoutSkin() {
        return createPlayerHeadWithProfile(null);
    }

    @NonNull private static ItemStack createPlayerHeadWithProfile(@Nullable PlayerProfile profile) {
        ItemStack head;
        if (USE_MODERN_HEADS) {
    ...
    @Nullable public static String getProfileSkinHash(@NonNull PlayerProfile profile) {
        String url = getProfileSkinUrl(profile);
        return url == null ? null : url.substring(url.lastIndexOf("/") + 1);
    }

    @Nullable public static String getProfileSkinUrl(@NonNull PlayerProfile profile) {
